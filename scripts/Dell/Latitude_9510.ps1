...
$userAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.85 Safari/537.36 Edg/90.0.818.46" #[Microsoft.PowerShell.Commands.PSUserAgent]::InternetExplorer
[System.String]$RootDir = Split-Path -Path (Split-Path -Path $PSScriptRoot -Parent) -Parent
[System.String]$oem = "Dell"
[System.String]$notes = "Latitude 9510 created manually."
...
if (Test-Path -Path .\9510\win10\x64)
{
    [System.Boolean]$x64 = $true
    $cpuArch += "x64"
    $archUID += "x64::"
}
if (Test-Path -Path .\9510\win10\x86)
{
    [System.Boolean]$x86 = $true
    $cpuArch += "x86"
    $archUID += "x86::"
}
if (Test-Path -Path .\9510\win10\arm64)
{
    [System.Boolean]$arm64 = $true
    $cpuArch += "arm64"
    $archUID += "arm64::"
}
if (Test-Path -Path .\9510\win10\aarch32)
{
