...
[System.String]$notes = "Latitude 9410 created manually."
[System.String]$winver = "Windows_10"
[System.String]$biosVersion = [System.String]::Empty
[System.Int32]$productionYear = 2020
...
<# LATITUDE 9410 WINDOWS 10 DRIVERS #>
$iwrObject = Invoke-WebRequest -Uri 'https://www.dell.com/support/kbdoc/en-au/000109721/latitude-9410-windows-10-driver-pack' -UserAgent $userAgent -UseBasicParsing
...
[System.String]$model = 'Latitude 9410'
...
if (Test-Path -Path .\9410\win10\x64)
{
    [System.Boolean]$x64 = $true
    $cpuArch += "x64"
    $archUID += "x64::"
}
if (Test-Path -Path .\9410\win10\x86)
{
    [System.Boolean]$x86 = $true
    $cpuArch += "x86"
    $archUID += "x86::"
}
if (Test-Path -Path .\9410\win10\arm64)
{
    [System.Boolean]$arm64 = $true
    $cpuArch += "arm64"
    $archUID += "arm64::"
}
if (Test-Path -Path .\9410\win10\aarch32)
{
